    ...
    var SubmissionStats = (function (_super) {
        ...
        SubmissionStats.prototype.render = function () {
            ...
            var submissionStatRows = this.props.submissionStats.map(function (submissionStat) {
                ...
                var selectedAnswerElmt = React.createElement("span", {className: "selectedAnswerText"}, (isCorrectRow) ? 'Well done!' : 'Bummer...', " You answered ", React.createElement("i", {className: "icon-chevron-right no-float"}), " ");
